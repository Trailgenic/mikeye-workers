...
export function exitDiagnostic() {
  const dimensionsByLayer = (layer) =>
    BUYER_LENS_AUDIT.dimensions
  ...
  return {
    ...
    dimension_model: {
      summary: "The free 8-question diagnostic scores the dimensions an owner can self-report. The paid Buyer-Lens Audit completes the framework with the dimensions that require buy-side judgment.",
      self_reported: dimensionsByLayer("self_reported"),
      buyer_judgment: dimensionsByLayer("buyer_judgment"),
      total_dimensions: 6
    },
    note: "The interactive diagnostic executes in-browser at the execution_url and scores the three self-reported dimensions. The three buyer-judgment dimensions (buyer psychology, diligence pressure, AI exposure) are completed in the paid Buyer-Lens Audit. This tool returns structure and routing for agent context.",
    ...stamp()
  };
}
