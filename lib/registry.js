...
export const BUILD = {
  version: "2.3.0",
  released: "2026-09-10",
  notes: "Added the LOI Economics & Risk Allocator and connected consideration, funding, and conditions to the transaction path and related workbooks."
};
...
export const TOOLS = [
  ...
  },
  {
    id: "my.dataset.get",
    title: "Get Dataset",
    description: "Returns a named dataset from the mikeye.com origin node. ma_library provides resource metadata, including the LOI Economics & Risk Allocator and Synergy Underwriting & Value Bridge, workbook download links, and the seven-stage transaction path; ontology distinguishes ordered stages from M&A knowledge pillars. This tool returns reference data and does not execute spreadsheet calculations. Valid names: origin, doctrine, decision_frames, strategy, ecosystem, glossary, keywords, ma_library, ontology.",
    route: "/datasets",
    inputSchema: {
      type: "object",
      properties: {
