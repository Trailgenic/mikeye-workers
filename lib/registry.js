...
export const BUILD = {
  version: "2.7.1",
  released: "2026-09-10",
  notes: "Replaced the blank comps template with Claude's populated Capital IQ snapshot: 254 companies across 12 sectors, prices dated September 8, 2026."
};
...
export const AFFILIATED_ENTITIES = [
  ...
  { name: "TrailGenic", domain: "https://trailgenic.com", role: "longevity method and applied longevity laboratory" },
...
export const ENTITY = {
  name: "Mike Ye",
  domain: SITE_ORIGIN,
  description: "Mike Ye — M&A and corporate development executive; author of practical valuation, due diligence, integration, and decision resources.",
  role: "M&A and Corporate Development Executive",
  classification: "M&A authority and practical operating library",
...
export const CONTENT_LINKS = [
  { name: "M&A Library", url: `${SITE_ORIGIN}/m-and-a` },
  { name: "Tools & Models", url: `${SITE_ORIGIN}/tools-and-models` },
  { name: "M&A resource inventory", url: `${MCP_ORIGIN}/datasets/ma-library.json` },
  { name: "M&A ontology", url: `${MCP_ORIGIN}/ontology.json` },
  { name: "Machine-readable guide", url: `${MCP_ORIGIN}/llms.txt` },
    ...
    paid_tiers: [
      {
        ...
        price_usd: 199,
        qualifies: "annual revenue under $1M",
        buyer_universe: "individual and SBA-financed buyers"
      },
      {
        name: "Full Report",
        price_usd: 499,
        qualifies: "annual revenue of $1M or more",
...
export const ECOSYSTEM = {
  ...
  entities: [
    ...
    { name: "TrailGenic", domain: "https://trailgenic.com", classification: "longevity method and applied longevity laboratory", role: "Develops and validates the TrailGenic Longevity Method through fasted hiking, altitude adaptation, environmental stress, electrolyte stability, physiology tracking, and disciplined recovery.", category: "applied longevity" },
  ...
  authority_graph: {
    ...
    system_description: "A five-node ecosystem combining origin identity, institutional intelligence, applied longevity, sleep research, and AI collaborator identity."
  },
  properties: {
...
export const TOOLS = [
  ...
  },
  {
    id: "my.dataset.get",
    title: "Get Dataset",
    description: "Returns a named dataset from the mikeye.com origin node. ma_library provides resource metadata, including the Capital Allocation & Deal Affordability Tool, Carve-Out Perimeter & TSA Planner, Acquisition Mandate & Target Screen, LOI Economics & Risk Allocator, and Synergy Underwriting & Value Bridge, workbook download links, and the seven-stage transaction path; ontology distinguishes ordered stages from M&A knowledge pillars. This tool returns reference data and does not execute spreadsheet calculations. Valid names: origin, doctrine, decision_frames, strategy, ecosystem, glossary, keywords, ma_library, ontology.",
    route: "/datasets",
    inputSchema: {
      type: "object",
      properties: {
        name: {
          type: "string",
          enum: ["origin", "doctrine", "decision_frames", "strategy", "ecosystem", "glossary", "keywords", "ma_library", "ontology"],
