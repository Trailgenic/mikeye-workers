...
export const BUILD = {
  version: "2.1.0",
  released: "2026-09-08",
  notes: "Added the practical M&A library, valuation workbooks, diligence and integration resources, and shared ontology."
};
...
export const TOOLS = [
  ...
  },
  {
    id: "my.dataset.get",
    title: "Get Dataset",
    description: "Returns a named dataset from the mikeye.com origin node. Valid names: origin, doctrine, decision_frames, strategy, ecosystem, glossary, keywords, ma_library, ontology.",
    route: "/datasets",
    inputSchema: {
      type: "object",
      properties: {
