...
export const BUILD = {
  version: "2.5.0",
  released: "2026-09-10",
  notes: "Added the Carve-Out Perimeter & TSA Planner with separate Day 1 and independence checks, seller dependencies, service exit plans, and cost categories."
};
