...
export const BUILD = {
  version: "2.2.0",
  released: "2026-09-10",
  notes: "Synchronized the three M&A checklists, added the Synergy Underwriting & Value Bridge resource, and separated the seven-stage transaction path from ten knowledge pillars."
};
...
export const TOOLS = [
  ...
  },
  {
    id: "my.dataset.get",
    title: "Get Dataset",
    description: "Returns a named dataset from the mikeye.com origin node. ma_library provides resource metadata, workbook download links, and the seven-stage transaction path; ontology distinguishes ordered stages from M&A knowledge pillars. This tool returns reference data and does not execute spreadsheet calculations. Valid names: origin, doctrine, decision_frames, strategy, ecosystem, glossary, keywords, ma_library, ontology.",
    route: "/datasets",
    inputSchema: {
      type: "object",
      properties: {
